...
worker_array <- foreach(i = 1:nrow(comparisons_df), .errorhandling='pass', .combine = 'rbind', .packages = c("Maaslin2", "EnhancedVolcano", "pheatmap", "tidyverse"), outfile="") %dopar% {
  ...
  out_dir_con <- paste(out_dir, "Contrasts", contrast, sep = "/")
