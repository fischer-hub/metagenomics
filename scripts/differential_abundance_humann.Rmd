...
ma_plot_gen <- plot.ma(results_df, "all groups") # maybe more color?? significance..
volcano_plot_total <- plot.volcano(results_df, "Total differential abundant features", results_df, "all groups")
